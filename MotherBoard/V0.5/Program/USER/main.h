...
#define LED_Yellow(Status) if(Status == 1)GPIO_ResetBits(GPIOB, GPIO_Pin_4);else if(Status == 0)GPIO_SetBits(GPIOB, GPIO_Pin_4)
#define LED_Green(Status) if(Status == 1)GPIO_ResetBits(GPIOB, GPIO_Pin_5);else if(Status == 0)GPIO_SetBits(GPIOB, GPIO_Pin_5)
