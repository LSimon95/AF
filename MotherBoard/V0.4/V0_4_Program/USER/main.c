...
//		}
//		
//		Debug_USART_Send_Char(number[Test_Int / 100]);
//		Debug_USART_Send_Char(number[Test_Int % 100 / 10]);
//		Debug_USART_Send_Char(number[Test_Int % 10]);
//		Debug_USART_Send_Char(0x0d);
//		Debug_USART_Send_Char(Fire_Detect());
//		/*i = XB_18B20_Get_Temperture();+
//		Debug_USART_Send_Char(i >> 8);
//		Debug_USART_Send_Char(i);*/
//		Delay_ms(100);
//		XB_ADC_Filter();
//		Debug_USART_Send_Char(XB_ADC_After_Filter[0] >> 8);
//		Debug_USART_Send_Char(XB_ADC_After_Filter[0]);
//		Debug_USART_Send_Char(0x88);
//		Delay_ms(100);
...
uint8_t Start_Fire(void)
{
	...
	for(Ctr = 0; Ctr < 25000 && (Command == NULL || Command == START_FIRE); Ctr++)
	{
		Delay_ms(1);
		Command = Get_Remote_Action();
	}
