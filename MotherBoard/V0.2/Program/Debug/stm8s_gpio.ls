 ...
 546  00da 85            	popw	x
 547  00db 81            	ret
 593                     ; 141 void GPIO_Write(GPIO_TypeDef* GPIOx, uint8_t PortVal)
 593                     ; 142 {
 594                     .text:	section	.text,new
 595  0000               _GPIO_Write:
 597  0000 89            	pushw	x
 598       00000000      OFST:	set	0
 601                     ; 143   GPIOx->ODR = PortVal;
 ...
 609  0006 85            	popw	x
 610  0007 81            	ret
 657                     ; 154 void GPIO_WriteHigh(GPIO_TypeDef* GPIOx, GPIO_Pin_TypeDef PortPins)
 657                     ; 155 {
 658                     .text:	section	.text,new
 659  0000               _GPIO_WriteHigh:
 661  0000 89            	pushw	x
 662       00000000      OFST:	set	0
 665                     ; 156   GPIOx->ODR |= (uint8_t)PortPins;
 667  0001 f6            	ld	a,(x)
 ...
 673  0005 85            	popw	x
 674  0006 81            	ret
 721                     ; 167 void GPIO_WriteLow(GPIO_TypeDef* GPIOx, GPIO_Pin_TypeDef PortPins)
 721                     ; 168 {
 722                     .text:	section	.text,new
 723  0000               _GPIO_WriteLow:
 725  0000 89            	pushw	x
 726       00000000      OFST:	set	0
 729                     ; 169   GPIOx->ODR &= (uint8_t)(~PortPins);
 ...
 738  0006 85            	popw	x
 739  0007 81            	ret
 786                     ; 180 void GPIO_WriteReverse(GPIO_TypeDef* GPIOx, GPIO_Pin_TypeDef PortPins)
 786                     ; 181 {
 787                     .text:	section	.text,new
 788  0000               _GPIO_WriteReverse:
 790  0000 89            	pushw	x
 791       00000000      OFST:	set	0
 794                     ; 182   GPIOx->ODR ^= (uint8_t)PortPins;
 796  0001 f6            	ld	a,(x)
 ...
 802  0005 85            	popw	x
 803  0006 81            	ret
 841                     ; 191 uint8_t GPIO_ReadOutputData(GPIO_TypeDef* GPIOx)
 841                     ; 192 {
 842                     .text:	section	.text,new
 843  0000               _GPIO_ReadOutputData:
 847                     ; 193   return ((uint8_t)GPIOx->ODR);
 849  0000 f6            	ld	a,(x)
 852  0001 81            	ret
 889                     ; 202 uint8_t GPIO_ReadInputData(GPIO_TypeDef* GPIOx)
 889                     ; 203 {
 890                     .text:	section	.text,new
 891  0000               _GPIO_ReadInputData:
 895                     ; 204   return ((uint8_t)GPIOx->IDR);
 897  0000 e601          	ld	a,(1,x)
 900  0002 81            	ret
 968                     ; 213 BitStatus GPIO_ReadInputPin(GPIO_TypeDef* GPIOx, GPIO_Pin_TypeDef GPIO_Pin)
 968                     ; 214 {
 ...
 982  0005 85            	popw	x
 983  0006 81            	ret
1062                     ; 225 void GPIO_ExternalPullUpConfig(GPIO_TypeDef* GPIOx, GPIO_Pin_TypeDef GPIO_Pin, FunctionalState NewState)
1062                     ; 226 {
1063                     .text:	section	.text,new
1064  0000               _GPIO_ExternalPullUpConfig:
1066  0000 89            	pushw	x
1067       00000000      OFST:	set	0
1070                     ; 228   assert_param(IS_GPIO_PIN_OK(GPIO_Pin));
1072  0001 0d05          	tnz	(OFST+5,sp)
1073  0003 2703          	jreq	L24
1074  0005 4f            	clr	a
1075  0006 2010          	jra	L44
1076  0008               L24:
1077  0008 ae00e4        	ldw	x,#228
...
1085  0018               L44:
1086                     ; 229   assert_param(IS_FUNCTIONALSTATE_OK(NewState));
...
1105  0035               L25:
1106                     ; 231   if (NewState != DISABLE) /* External Pull-Up Set*/
1108  0035 0d06          	tnz	(OFST+6,sp)
1109  0037 270a          	jreq	L574
1110                     ; 233     GPIOx->CR1 |= (uint8_t)GPIO_Pin;
...
1118  0043               L574:
1119                     ; 236     GPIOx->CR1 &= (uint8_t)(~(GPIO_Pin));
...
1156  0000               L771:
1157  0000 73746d38735f  	dc.b	"stm8s_stdperiph_li"
1158  0012 625c6c696272  	dc.b	"b\libraries\stm8s_"
1159  0024 737464706572  	dc.b	"stdperiph_driver\s"
1160  0036 72635c73746d  	dc.b	"rc\stm8s_gpio.c",0
1180                     	end
