 ...
 511  0032               L61:
 512                     ; 115   assert_param(IS_TIM2_OUTPUT_STATE_OK(TIM2_OutputState));
 ...
 531  004f               L42:
 532                     ; 116   assert_param(IS_TIM2_OC_POLARITY_OK(TIM2_OCPolarity));
 ...
 551  006c               L23:
 552                     ; 119   TIM2->CCER1 &= (uint8_t)(~( TIM2_CCER1_CC1E | TIM2_CCER1_CC1P));
 554  006c c65308        	ld	a,21256
 555  006f a4fc          	and	a,#252
 556  0071 c75308        	ld	21256,a
 557                     ; 121   TIM2->CCER1 |= (uint8_t)((uint8_t)(TIM2_OutputState & TIM2_CCER1_CC1E ) | 
 557                     ; 122                            (uint8_t)(TIM2_OCPolarity & TIM2_CCER1_CC1P));
 ...
 734  006c c65308        	ld	a,21256
 735  006f a4cf          	and	a,#207
 736  0071 c75308        	ld	21256,a
 ...
 914  006c c65309        	ld	a,21257
 915  006f a4fc          	and	a,#252
 916  0071 c75309        	ld	21257,a
...
1538  0095               L164:
1539                     ; 288     icpolarity = (uint8_t)TIM2_ICPOLARITY_RISING;
1541  0095 0f01          	clr	(OFST-1,sp)
1542  0097               L364:
1543                     ; 292   if (TIM2_ICSelection == TIM2_ICSELECTION_DIRECTTI)
1545  0097 7b07          	ld	a,(OFST+5,sp)
1546  0099 a101          	cp	a,#1
1547  009b 2606          	jrne	L564
1548                     ; 294     icselection = (uint8_t)TIM2_ICSELECTION_INDIRECTTI;
1550  009d a602          	ld	a,#2
1551  009f 6b02          	ld	(OFST+0,sp),a
1553  00a1 2004          	jra	L764
1554  00a3               L564:
1555                     ; 298     icselection = (uint8_t)TIM2_ICSELECTION_DIRECTTI;
1557  00a3 a601          	ld	a,#1
1558  00a5 6b02          	ld	(OFST+0,sp),a
1559  00a7               L764:
1560                     ; 301   if (TIM2_Channel == TIM2_CHANNEL_1)
1562  00a7 0d03          	tnz	(OFST+1,sp)
1563  00a9 2626          	jrne	L174
1564                     ; 304     TI1_Config((uint8_t)TIM2_ICPolarity, (uint8_t)TIM2_ICSelection,
1564                     ; 305                (uint8_t)TIM2_ICFilter);
...
1574  00b7 84            	pop	a
1575                     ; 308     TIM2_SetIC1Prescaler(TIM2_ICPrescaler);
1577  00b8 7b08          	ld	a,(OFST+6,sp)
1578  00ba cd0000        	call	_TIM2_SetIC1Prescaler
1580                     ; 311     TI2_Config(icpolarity, icselection, TIM2_ICFilter);
...
1590  00c9 84            	pop	a
1591                     ; 314     TIM2_SetIC2Prescaler(TIM2_ICPrescaler);
1593  00ca 7b08          	ld	a,(OFST+6,sp)
1594  00cc cd0000        	call	_TIM2_SetIC2Prescaler
1597  00cf 2024          	jra	L374
1598  00d1               L174:
1599                     ; 319     TI2_Config((uint8_t)TIM2_ICPolarity, (uint8_t)TIM2_ICSelection,
1599                     ; 320                (uint8_t)TIM2_ICFilter);
...
1609  00dd 84            	pop	a
1610                     ; 323     TIM2_SetIC2Prescaler(TIM2_ICPrescaler);
1612  00de 7b08          	ld	a,(OFST+6,sp)
1613  00e0 cd0000        	call	_TIM2_SetIC2Prescaler
1615                     ; 326     TI1_Config((uint8_t)icpolarity, icselection, (uint8_t)TIM2_ICFilter);
...
1625  00ef 84            	pop	a
1626                     ; 329     TIM2_SetIC1Prescaler(TIM2_ICPrescaler);
...
1736  0029 84            	pop	a
1737  002a 81            	ret
1817                     ; 368 void TIM2_ITConfig(TIM2_IT_TypeDef TIM2_IT, FunctionalState NewState)
1817                     ; 369 {
1818                     .text:	section	.text,new
1819  0000               _TIM2_ITConfig:
1821  0000 89            	pushw	x
1822       00000000      OFST:	set	0
1825                     ; 371   assert_param(IS_TIM2_IT_OK(TIM2_IT));
...
1844  001d               L012:
1845                     ; 372   assert_param(IS_FUNCTIONALSTATE_OK(NewState));
...
1864  003a               L612:
1865                     ; 374   if (NewState != DISABLE)
1867  003a 0d02          	tnz	(OFST+2,sp)
1868  003c 270a          	jreq	L565
1869                     ; 377     TIM2->IER |= (uint8_t)TIM2_IT;
1871  003e c65301        	ld	a,21249
1872  0041 1a01          	or	a,(OFST+1,sp)
1873  0043 c75301        	ld	21249,a
1875  0046 2009          	jra	L765
1876  0048               L565:
1877                     ; 382     TIM2->IER &= (uint8_t)(~TIM2_IT);
1879  0048 7b01          	ld	a,(OFST+1,sp)
1880  004a 43            	cpl	a
1881  004b c45301        	and	a,21249
1882  004e c75301        	ld	21249,a
1883  0051               L765:
1884                     ; 384 }
1887  0051 85            	popw	x
1888  0052 81            	ret
1925                     ; 392 void TIM2_UpdateDisableConfig(FunctionalState NewState)
1925                     ; 393 {
1926                     .text:	section	.text,new
1927  0000               _TIM2_UpdateDisableConfig:
1929  0000 88            	push	a
1930       00000000      OFST:	set	0
1933                     ; 395   assert_param(IS_FUNCTIONALSTATE_OK(NewState));
1935  0001 4d            	tnz	a
...
1951  001b               L622:
1952                     ; 398   if (NewState != DISABLE)
1954  001b 0d01          	tnz	(OFST+1,sp)
1955  001d 2706          	jreq	L706
1956                     ; 400     TIM2->CR1 |= (uint8_t)TIM2_CR1_UDIS;
1958  001f 72125300      	bset	21248,#1
1960  0023 2004          	jra	L116
1961  0025               L706:
1962                     ; 404     TIM2->CR1 &= (uint8_t)(~TIM2_CR1_UDIS);
1964  0025 72135300      	bres	21248,#1
1965  0029               L116:
1966                     ; 406 }
1969  0029 84            	pop	a
1970  002a 81            	ret
2029                     ; 416 void TIM2_UpdateRequestConfig(TIM2_UpdateSource_TypeDef TIM2_UpdateSource)
2029                     ; 417 {
2030                     .text:	section	.text,new
2031  0000               _TIM2_UpdateRequestConfig:
2033  0000 88            	push	a
2034       00000000      OFST:	set	0
2037                     ; 419   assert_param(IS_TIM2_UPDATE_SOURCE_OK(TIM2_UpdateSource));
2039  0001 4d            	tnz	a
...
2055  001b               L632:
2056                     ; 422   if (TIM2_UpdateSource != TIM2_UPDATESOURCE_GLOBAL)
2058  001b 0d01          	tnz	(OFST+1,sp)
2059  001d 2706          	jreq	L146
2060                     ; 424     TIM2->CR1 |= (uint8_t)TIM2_CR1_URS;
2062  001f 72145300      	bset	21248,#2
2064  0023 2004          	jra	L346
2065  0025               L146:
2066                     ; 428     TIM2->CR1 &= (uint8_t)(~TIM2_CR1_URS);
2068  0025 72155300      	bres	21248,#2
2069  0029               L346:
2070                     ; 430 }
2073  0029 84            	pop	a
2074  002a 81            	ret
2132                     ; 440 void TIM2_SelectOnePulseMode(TIM2_OPMode_TypeDef TIM2_OPMode)
2132                     ; 441 {
2133                     .text:	section	.text,new
2134  0000               _TIM2_SelectOnePulseMode:
2136  0000 88            	push	a
2137       00000000      OFST:	set	0
2140                     ; 443   assert_param(IS_TIM2_OPM_MODE_OK(TIM2_OPMode));
...
2158  001b               L642:
2159                     ; 446   if (TIM2_OPMode != TIM2_OPMODE_REPETITIVE)
2161  001b 0d01          	tnz	(OFST+1,sp)
2162  001d 2706          	jreq	L376
2163                     ; 448     TIM2->CR1 |= (uint8_t)TIM2_CR1_OPM;
2165  001f 72165300      	bset	21248,#3
2167  0023 2004          	jra	L576
2168  0025               L376:
2169                     ; 452     TIM2->CR1 &= (uint8_t)(~TIM2_CR1_OPM);
2171  0025 72175300      	bres	21248,#3
2172  0029               L576:
2173                     ; 454 }
2176  0029 84            	pop	a
2177  002a 81            	ret
2246                     ; 484 void TIM2_PrescalerConfig(TIM2_Prescaler_TypeDef Prescaler,
2246                     ; 485                           TIM2_PSCReloadMode_TypeDef TIM2_PSCReloadMode)
2246                     ; 486 {
2247                     .text:	section	.text,new
2248  0000               _TIM2_PrescalerConfig:
2250  0000 89            	pushw	x
2251       00000000      OFST:	set	0
2254                     ; 488   assert_param(IS_TIM2_PRESCALER_RELOAD_OK(TIM2_PSCReloadMode));
...
2274  001d               L652:
2275                     ; 489   assert_param(IS_TIM2_PRESCALER_OK(Prescaler));
...
2336  008e               L462:
2337                     ; 492   TIM2->PSCR = (uint8_t)Prescaler;
2339  008e 7b01          	ld	a,(OFST+1,sp)
2340  0090 c7530c        	ld	21260,a
2341                     ; 495   TIM2->EGR = (uint8_t)TIM2_PSCReloadMode;
2343  0093 7b02          	ld	a,(OFST+2,sp)
2344  0095 c75304        	ld	21252,a
2345                     ; 496 }
2348  0098 85            	popw	x
2349  0099 81            	ret
2408                     ; 507 void TIM2_ForcedOC1Config(TIM2_ForcedAction_TypeDef TIM2_ForcedAction)
2408                     ; 508 {
2409                     .text:	section	.text,new
2410  0000               _TIM2_ForcedOC1Config:
2412  0000 88            	push	a
2413       00000000      OFST:	set	0
2416                     ; 510   assert_param(IS_TIM2_FORCED_ACTION_OK(TIM2_ForcedAction));
...
2434  001c               L472:
2435                     ; 513   TIM2->CCMR1  =  (uint8_t)((uint8_t)(TIM2->CCMR1 & (uint8_t)(~TIM2_CCMR_OCM))  
2435                     ; 514                             | (uint8_t)TIM2_ForcedAction);
2437  001c c65305        	ld	a,21253
2438  001f a48f          	and	a,#143
2439  0021 1a01          	or	a,(OFST+1,sp)
2440  0023 c75305        	ld	21253,a
2441                     ; 515 }
2444  0026 84            	pop	a
2445  0027 81            	ret
2482                     ; 526 void TIM2_ForcedOC2Config(TIM2_ForcedAction_TypeDef TIM2_ForcedAction)
2482                     ; 527 {
2483                     .text:	section	.text,new
2484  0000               _TIM2_ForcedOC2Config:
2486  0000 88            	push	a
2487       00000000      OFST:	set	0
2490                     ; 529   assert_param(IS_TIM2_FORCED_ACTION_OK(TIM2_ForcedAction));
...
2508  001c               L403:
2509                     ; 532   TIM2->CCMR2 = (uint8_t)((uint8_t)(TIM2->CCMR2 & (uint8_t)(~TIM2_CCMR_OCM))  
2509                     ; 533                           | (uint8_t)TIM2_ForcedAction);
2511  001c c65306        	ld	a,21254
2512  001f a48f          	and	a,#143
2513  0021 1a01          	or	a,(OFST+1,sp)
2514  0023 c75306        	ld	21254,a
2515                     ; 534 }
2518  0026 84            	pop	a
2519  0027 81            	ret
2556                     ; 545 void TIM2_ForcedOC3Config(TIM2_ForcedAction_TypeDef TIM2_ForcedAction)
2556                     ; 546 {
2557                     .text:	section	.text,new
2558  0000               _TIM2_ForcedOC3Config:
2560  0000 88            	push	a
2561       00000000      OFST:	set	0
2564                     ; 548   assert_param(IS_TIM2_FORCED_ACTION_OK(TIM2_ForcedAction));
...
2582  001c               L413:
2583                     ; 551   TIM2->CCMR3  =  (uint8_t)((uint8_t)(TIM2->CCMR3 & (uint8_t)(~TIM2_CCMR_OCM))
2583                     ; 552                             | (uint8_t)TIM2_ForcedAction);
2585  001c c65307        	ld	a,21255
2586  001f a48f          	and	a,#143
2587  0021 1a01          	or	a,(OFST+1,sp)
2588  0023 c75307        	ld	21255,a
2589                     ; 553 }
2592  0026 84            	pop	a
2593  0027 81            	ret
2630                     ; 561 void TIM2_ARRPreloadConfig(FunctionalState NewState)
2630                     ; 562 {
2631                     .text:	section	.text,new
2632  0000               _TIM2_ARRPreloadConfig:
2634  0000 88            	push	a
2635       00000000      OFST:	set	0
2638                     ; 564   assert_param(IS_FUNCTIONALSTATE_OK(NewState));
2640  0001 4d            	tnz	a
...
2738  001b               L433:
2739                     ; 589   if (NewState != DISABLE)
2741  001b 0d01          	tnz	(OFST+1,sp)
2742  001d 2706          	jreq	L3501
2743                     ; 591     TIM2->CCMR1 |= (uint8_t)TIM2_CCMR_OCxPE;
2745  001f 72165305      	bset	21253,#3
2747  0023 2004          	jra	L5501
2748  0025               L3501:
2749                     ; 595     TIM2->CCMR1 &= (uint8_t)(~TIM2_CCMR_OCxPE);
2751  0025 72175305      	bres	21253,#3
2752  0029               L5501:
2753                     ; 597 }
2756  0029 84            	pop	a
2757  002a 81            	ret
2794                     ; 605 void TIM2_OC2PreloadConfig(FunctionalState NewState)
2794                     ; 606 {
2795                     .text:	section	.text,new
2796  0000               _TIM2_OC2PreloadConfig:
2798  0000 88            	push	a
2799       00000000      OFST:	set	0
2802                     ; 608   assert_param(IS_FUNCTIONALSTATE_OK(NewState));
2804  0001 4d            	tnz	a
...
2820  001b               L443:
2821                     ; 611   if (NewState != DISABLE)
2823  001b 0d01          	tnz	(OFST+1,sp)
2824  001d 2706          	jreq	L5701
2825                     ; 613     TIM2->CCMR2 |= (uint8_t)TIM2_CCMR_OCxPE;
2827  001f 72165306      	bset	21254,#3
2829  0023 2004          	jra	L7701
2830  0025               L5701:
2831                     ; 617     TIM2->CCMR2 &= (uint8_t)(~TIM2_CCMR_OCxPE);
2833  0025 72175306      	bres	21254,#3
2834  0029               L7701:
2835                     ; 619 }
2838  0029 84            	pop	a
2839  002a 81            	ret
2876                     ; 627 void TIM2_OC3PreloadConfig(FunctionalState NewState)
2876                     ; 628 {
2877                     .text:	section	.text,new
2878  0000               _TIM2_OC3PreloadConfig:
2880  0000 88            	push	a
2881       00000000      OFST:	set	0
2884                     ; 630   assert_param(IS_FUNCTIONALSTATE_OK(NewState));
2886  0001 4d            	tnz	a
...
2902  001b               L453:
2903                     ; 633   if (NewState != DISABLE)
2905  001b 0d01          	tnz	(OFST+1,sp)
2906  001d 2706          	jreq	L7111
2907                     ; 635     TIM2->CCMR3 |= (uint8_t)TIM2_CCMR_OCxPE;
2909  001f 72165307      	bset	21255,#3
2911  0023 2004          	jra	L1211
2912  0025               L7111:
2913                     ; 639     TIM2->CCMR3 &= (uint8_t)(~TIM2_CCMR_OCxPE);
2915  0025 72175307      	bres	21255,#3
2916  0029               L1211:
2917                     ; 641 }
2920  0029 84            	pop	a
2921  002a 81            	ret
2995                     ; 653 void TIM2_GenerateEvent(TIM2_EventSource_TypeDef TIM2_EventSource)
2995                     ; 654 {
2996                     .text:	section	.text,new
2997  0000               _TIM2_GenerateEvent:
2999  0000 88            	push	a
3000       00000000      OFST:	set	0
3003                     ; 656   assert_param(IS_TIM2_EVENT_SOURCE_OK(TIM2_EventSource));
3005  0001 4d            	tnz	a
3006  0002 2703          	jreq	L063
3007  0004 4f            	clr	a
3008  0005 2010          	jra	L263
3009  0007               L063:
3010  0007 ae0290        	ldw	x,#656
...
3018  0017               L263:
3019                     ; 659   TIM2->EGR = (uint8_t)TIM2_EventSource;
3021  0017 7b01          	ld	a,(OFST+1,sp)
3022  0019 c75304        	ld	21252,a
3023                     ; 660 }
3026  001c 84            	pop	a
3027  001d 81            	ret
3064                     ; 670 void TIM2_OC1PolarityConfig(TIM2_OCPolarity_TypeDef TIM2_OCPolarity)
3064                     ; 671 {
3065                     .text:	section	.text,new
3066  0000               _TIM2_OC1PolarityConfig:
3068  0000 88            	push	a
3069       00000000      OFST:	set	0
3072                     ; 673   assert_param(IS_TIM2_OC_POLARITY_OK(TIM2_OCPolarity));
3074  0001 4d            	tnz	a
...
3090  001b               L273:
3091                     ; 676   if (TIM2_OCPolarity != TIM2_OCPOLARITY_HIGH)
3093  001b 0d01          	tnz	(OFST+1,sp)
3094  001d 2706          	jreq	L3711
3095                     ; 678     TIM2->CCER1 |= (uint8_t)TIM2_CCER1_CC1P;
3097  001f 72125308      	bset	21256,#1
3099  0023 2004          	jra	L5711
3100  0025               L3711:
3101                     ; 682     TIM2->CCER1 &= (uint8_t)(~TIM2_CCER1_CC1P);
3103  0025 72135308      	bres	21256,#1
3104  0029               L5711:
3105                     ; 684 }
3108  0029 84            	pop	a
3109  002a 81            	ret
3146                     ; 694 void TIM2_OC2PolarityConfig(TIM2_OCPolarity_TypeDef TIM2_OCPolarity)
3146                     ; 695 {
3147                     .text:	section	.text,new
3148  0000               _TIM2_OC2PolarityConfig:
3150  0000 88            	push	a
3151       00000000      OFST:	set	0
3154                     ; 697   assert_param(IS_TIM2_OC_POLARITY_OK(TIM2_OCPolarity));
3156  0001 4d            	tnz	a
...
3172  001b               L204:
3173                     ; 700   if (TIM2_OCPolarity != TIM2_OCPOLARITY_HIGH)
3175  001b 0d01          	tnz	(OFST+1,sp)
3176  001d 2706          	jreq	L5121
3177                     ; 702     TIM2->CCER1 |= TIM2_CCER1_CC2P;
3179  001f 721a5308      	bset	21256,#5
3181  0023 2004          	jra	L7121
3182  0025               L5121:
3183                     ; 706     TIM2->CCER1 &= (uint8_t)(~TIM2_CCER1_CC2P);
3185  0025 721b5308      	bres	21256,#5
3186  0029               L7121:
3187                     ; 708 }
3190  0029 84            	pop	a
3191  002a 81            	ret
3228                     ; 718 void TIM2_OC3PolarityConfig(TIM2_OCPolarity_TypeDef TIM2_OCPolarity)
3228                     ; 719 {
3229                     .text:	section	.text,new
3230  0000               _TIM2_OC3PolarityConfig:
3232  0000 88            	push	a
3233       00000000      OFST:	set	0
3236                     ; 721   assert_param(IS_TIM2_OC_POLARITY_OK(TIM2_OCPolarity));
3238  0001 4d            	tnz	a
...
3254  001b               L214:
3255                     ; 724   if (TIM2_OCPolarity != TIM2_OCPOLARITY_HIGH)
3257  001b 0d01          	tnz	(OFST+1,sp)
3258  001d 2706          	jreq	L7321
3259                     ; 726     TIM2->CCER2 |= (uint8_t)TIM2_CCER2_CC3P;
3261  001f 72125309      	bset	21257,#1
3263  0023 2004          	jra	L1421
3264  0025               L7321:
3265                     ; 730     TIM2->CCER2 &= (uint8_t)(~TIM2_CCER2_CC3P);
3267  0025 72135309      	bres	21257,#1
3268  0029               L1421:
3269                     ; 732 }
3272  0029 84            	pop	a
3273  002a 81            	ret
3319                     ; 745 void TIM2_CCxCmd(TIM2_Channel_TypeDef TIM2_Channel, FunctionalState NewState)
3319                     ; 746 {
3320                     .text:	section	.text,new
3321  0000               _TIM2_CCxCmd:
3323  0000 89            	pushw	x
3324       00000000      OFST:	set	0
3327                     ; 748   assert_param(IS_TIM2_CHANNEL_OK(TIM2_Channel));
...
3350  0022               L224:
3351                     ; 749   assert_param(IS_FUNCTIONALSTATE_OK(NewState));
...
3370  003f               L034:
3371                     ; 751   if (TIM2_Channel == TIM2_CHANNEL_1)
3373  003f 0d01          	tnz	(OFST+1,sp)
3374  0041 2610          	jrne	L5621
3375                     ; 754     if (NewState != DISABLE)
3377  0043 0d02          	tnz	(OFST+2,sp)
3378  0045 2706          	jreq	L7621
3379                     ; 756       TIM2->CCER1 |= (uint8_t)TIM2_CCER1_CC1E;
3381  0047 72105308      	bset	21256,#0
3383  004b 202a          	jra	L3721
3384  004d               L7621:
3385                     ; 760       TIM2->CCER1 &= (uint8_t)(~TIM2_CCER1_CC1E);
3387  004d 72115308      	bres	21256,#0
3388  0051 2024          	jra	L3721
3389  0053               L5621:
3390                     ; 764   else if (TIM2_Channel == TIM2_CHANNEL_2)
3392  0053 7b01          	ld	a,(OFST+1,sp)
3393  0055 a101          	cp	a,#1
3394  0057 2610          	jrne	L5721
3395                     ; 767     if (NewState != DISABLE)
3397  0059 0d02          	tnz	(OFST+2,sp)
3398  005b 2706          	jreq	L7721
3399                     ; 769       TIM2->CCER1 |= (uint8_t)TIM2_CCER1_CC2E;
3401  005d 72185308      	bset	21256,#4
3403  0061 2014          	jra	L3721
3404  0063               L7721:
3405                     ; 773       TIM2->CCER1 &= (uint8_t)(~TIM2_CCER1_CC2E);
3407  0063 72195308      	bres	21256,#4
3408  0067 200e          	jra	L3721
3409  0069               L5721:
3410                     ; 779     if (NewState != DISABLE)
3412  0069 0d02          	tnz	(OFST+2,sp)
3413  006b 2706          	jreq	L5031
3414                     ; 781       TIM2->CCER2 |= (uint8_t)TIM2_CCER2_CC3E;
3416  006d 72105309      	bset	21257,#0
3418  0071 2004          	jra	L3721
3419  0073               L5031:
3420                     ; 785       TIM2->CCER2 &= (uint8_t)(~TIM2_CCER2_CC3E);
3422  0073 72115309      	bres	21257,#0
3423  0077               L3721:
3424                     ; 788 }
3427  0077 85            	popw	x
3428  0078 81            	ret
3474                     ; 810 void TIM2_SelectOCxM(TIM2_Channel_TypeDef TIM2_Channel, TIM2_OCMode_TypeDef TIM2_OCMode)
3474                     ; 811 {
3475                     .text:	section	.text,new
3476  0000               _TIM2_SelectOCxM:
3478  0000 89            	pushw	x
3479       00000000      OFST:	set	0
3482                     ; 813   assert_param(IS_TIM2_CHANNEL_OK(TIM2_Channel));
...
3505  0022               L044:
3506                     ; 814   assert_param(IS_TIM2_OCM_OK(TIM2_OCMode));
...
3543  0063               L644:
3544                     ; 816   if (TIM2_Channel == TIM2_CHANNEL_1)
3546  0063 0d01          	tnz	(OFST+1,sp)
3547  0065 2610          	jrne	L3331
3548                     ; 819     TIM2->CCER1 &= (uint8_t)(~TIM2_CCER1_CC1E);
3550  0067 72115308      	bres	21256,#0
3551                     ; 822     TIM2->CCMR1 = (uint8_t)((uint8_t)(TIM2->CCMR1 & (uint8_t)(~TIM2_CCMR_OCM))
3551                     ; 823                             | (uint8_t)TIM2_OCMode);
3553  006b c65305        	ld	a,21253
3554  006e a48f          	and	a,#143
3555  0070 1a02          	or	a,(OFST+2,sp)
3556  0072 c75305        	ld	21253,a
3558  0075 2024          	jra	L5331
3559  0077               L3331:
3560                     ; 825   else if (TIM2_Channel == TIM2_CHANNEL_2)
3562  0077 7b01          	ld	a,(OFST+1,sp)
3563  0079 a101          	cp	a,#1
3564  007b 2610          	jrne	L7331
3565                     ; 828     TIM2->CCER1 &= (uint8_t)(~TIM2_CCER1_CC2E);
3567  007d 72195308      	bres	21256,#4
3568                     ; 831     TIM2->CCMR2 = (uint8_t)((uint8_t)(TIM2->CCMR2 & (uint8_t)(~TIM2_CCMR_OCM))
3568                     ; 832                             | (uint8_t)TIM2_OCMode);
3570  0081 c65306        	ld	a,21254
3571  0084 a48f          	and	a,#143
3572  0086 1a02          	or	a,(OFST+2,sp)
3573  0088 c75306        	ld	21254,a
3575  008b 200e          	jra	L5331
3576  008d               L7331:
3577                     ; 837     TIM2->CCER2 &= (uint8_t)(~TIM2_CCER2_CC3E);
3579  008d 72115309      	bres	21257,#0
3580                     ; 840     TIM2->CCMR3 = (uint8_t)((uint8_t)(TIM2->CCMR3 & (uint8_t)(~TIM2_CCMR_OCM))
3580                     ; 841                             | (uint8_t)TIM2_OCMode);
3582  0091 c65307        	ld	a,21255
3583  0094 a48f          	and	a,#143
3584  0096 1a02          	or	a,(OFST+2,sp)
3585  0098 c75307        	ld	21255,a
3586  009b               L5331:
3587                     ; 843 }
3590  009b 85            	popw	x
3591  009c 81            	ret
3625                     ; 851 void TIM2_SetCounter(uint16_t Counter)
3625                     ; 852 {
3626                     .text:	section	.text,new
3627  0000               _TIM2_SetCounter:
3631                     ; 854   TIM2->CNTRH = (uint8_t)(Counter >> 8);
3633  0000 9e            	ld	a,xh
3634  0001 c7530a        	ld	21258,a
3635                     ; 855   TIM2->CNTRL = (uint8_t)(Counter);
3637  0004 9f            	ld	a,xl
3638  0005 c7530b        	ld	21259,a
3639                     ; 856 }
3642  0008 81            	ret
3676                     ; 864 void TIM2_SetAutoreload(uint16_t Autoreload)
3676                     ; 865 {
3677                     .text:	section	.text,new
3678  0000               _TIM2_SetAutoreload:
3682                     ; 867   TIM2->ARRH = (uint8_t)(Autoreload >> 8);
3684  0000 9e            	ld	a,xh
3685  0001 c7530d        	ld	21261,a
3686                     ; 868   TIM2->ARRL = (uint8_t)(Autoreload);
3688  0004 9f            	ld	a,xl
3689  0005 c7530e        	ld	21262,a
3690                     ; 869 }
3693  0008 81            	ret
3727                     ; 877 void TIM2_SetCompare1(uint16_t Compare1)
3727                     ; 878 {
3728                     .text:	section	.text,new
3729  0000               _TIM2_SetCompare1:
3733                     ; 880   TIM2->CCR1H = (uint8_t)(Compare1 >> 8);
3735  0000 9e            	ld	a,xh
3736  0001 c7530f        	ld	21263,a
3737                     ; 881   TIM2->CCR1L = (uint8_t)(Compare1);
3739  0004 9f            	ld	a,xl
3740  0005 c75310        	ld	21264,a
3741                     ; 882 }
3744  0008 81            	ret
3778                     ; 890 void TIM2_SetCompare2(uint16_t Compare2)
3778                     ; 891 {
3779                     .text:	section	.text,new
3780  0000               _TIM2_SetCompare2:
3784                     ; 893   TIM2->CCR2H = (uint8_t)(Compare2 >> 8);
3786  0000 9e            	ld	a,xh
3787  0001 c75311        	ld	21265,a
3788                     ; 894   TIM2->CCR2L = (uint8_t)(Compare2);
3790  0004 9f            	ld	a,xl
3791  0005 c75312        	ld	21266,a
3792                     ; 895 }
3795  0008 81            	ret
3829                     ; 903 void TIM2_SetCompare3(uint16_t Compare3)
3829                     ; 904 {
3830                     .text:	section	.text,new
3831  0000               _TIM2_SetCompare3:
3835                     ; 906   TIM2->CCR3H = (uint8_t)(Compare3 >> 8);
3837  0000 9e            	ld	a,xh
3838  0001 c75313        	ld	21267,a
3839                     ; 907   TIM2->CCR3L = (uint8_t)(Compare3);
3841  0004 9f            	ld	a,xl
3842  0005 c75314        	ld	21268,a
3843                     ; 908 }
3846  0008 81            	ret
3883                     ; 920 void TIM2_SetIC1Prescaler(TIM2_ICPSC_TypeDef TIM2_IC1Prescaler)
3883                     ; 921 {
3884                     .text:	section	.text,new
3885  0000               _TIM2_SetIC1Prescaler:
3887  0000 88            	push	a
3888       00000000      OFST:	set	0
3891                     ; 923   assert_param(IS_TIM2_IC_PRESCALER_OK(TIM2_IC1Prescaler));
3893  0001 4d            	tnz	a
...
3913  0023               L074:
3914                     ; 926   TIM2->CCMR1 = (uint8_t)((uint8_t)(TIM2->CCMR1 & (uint8_t)(~TIM2_CCMR_ICxPSC))
3914                     ; 927                           | (uint8_t)TIM2_IC1Prescaler);
3916  0023 c65305        	ld	a,21253
3917  0026 a4f3          	and	a,#243
3918  0028 1a01          	or	a,(OFST+1,sp)
3919  002a c75305        	ld	21253,a
3920                     ; 928 }
3923  002d 84            	pop	a
3924  002e 81            	ret
3961                     ; 940 void TIM2_SetIC2Prescaler(TIM2_ICPSC_TypeDef TIM2_IC2Prescaler)
3961                     ; 941 {
3962                     .text:	section	.text,new
3963  0000               _TIM2_SetIC2Prescaler:
3965  0000 88            	push	a
3966       00000000      OFST:	set	0
3969                     ; 943   assert_param(IS_TIM2_IC_PRESCALER_OK(TIM2_IC2Prescaler));
3971  0001 4d            	tnz	a
...
3991  0023               L005:
3992                     ; 946   TIM2->CCMR2 = (uint8_t)((uint8_t)(TIM2->CCMR2 & (uint8_t)(~TIM2_CCMR_ICxPSC))
3992                     ; 947                           | (uint8_t)TIM2_IC2Prescaler);
3994  0023 c65306        	ld	a,21254
3995  0026 a4f3          	and	a,#243
3996  0028 1a01          	or	a,(OFST+1,sp)
3997  002a c75306        	ld	21254,a
3998                     ; 948 }
4001  002d 84            	pop	a
4002  002e 81            	ret
4039                     ; 960 void TIM2_SetIC3Prescaler(TIM2_ICPSC_TypeDef TIM2_IC3Prescaler)
4039                     ; 961 {
4040                     .text:	section	.text,new
4041  0000               _TIM2_SetIC3Prescaler:
4043  0000 88            	push	a
4044       00000000      OFST:	set	0
4047                     ; 964   assert_param(IS_TIM2_IC_PRESCALER_OK(TIM2_IC3Prescaler));
4049  0001 4d            	tnz	a
...
4069  0023               L015:
4070                     ; 966   TIM2->CCMR3 = (uint8_t)((uint8_t)(TIM2->CCMR3 & (uint8_t)(~TIM2_CCMR_ICxPSC))
4070                     ; 967                           | (uint8_t)TIM2_IC3Prescaler);
4072  0023 c65307        	ld	a,21255
4073  0026 a4f3          	and	a,#243
4074  0028 1a01          	or	a,(OFST+1,sp)
4075  002a c75307        	ld	21255,a
4076                     ; 968 }
4079  002d 84            	pop	a
4080  002e 81            	ret
4132                     ; 975 uint16_t TIM2_GetCapture1(void)
4132                     ; 976 {
4133                     .text:	section	.text,new
4134  0000               _TIM2_GetCapture1:
4136  0000 5204          	subw	sp,#4
4137       00000004      OFST:	set	4
4140                     ; 978   uint16_t tmpccr1 = 0;
4142                     ; 979   uint8_t tmpccr1l=0, tmpccr1h=0;
4146                     ; 981   tmpccr1h = TIM2->CCR1H;
4148  0002 c6530f        	ld	a,21263
4149  0005 6b02          	ld	(OFST-2,sp),a
4150                     ; 982   tmpccr1l = TIM2->CCR1L;
4152  0007 c65310        	ld	a,21264
4153  000a 6b01          	ld	(OFST-3,sp),a
4154                     ; 984   tmpccr1 = (uint16_t)(tmpccr1l);
4156  000c 7b01          	ld	a,(OFST-3,sp)
4157  000e 5f            	clrw	x
4158  000f 97            	ld	xl,a
4159  0010 1f03          	ldw	(OFST-1,sp),x
4160                     ; 985   tmpccr1 |= (uint16_t)((uint16_t)tmpccr1h << 8);
...
4340                     ; 1019   uint8_t tmpccr3l=0, tmpccr3h=0;
4344                     ; 1021   tmpccr3h = TIM2->CCR3H;
4346  0002 c65313        	ld	a,21267
4347  0005 6b02          	ld	(OFST-2,sp),a
4348                     ; 1022   tmpccr3l = TIM2->CCR3L;
4350  0007 c65314        	ld	a,21268
4351  000a 6b01          	ld	(OFST-3,sp),a
4352                     ; 1024   tmpccr3 = (uint16_t)(tmpccr3l);
4354  000c 7b01          	ld	a,(OFST-3,sp)
4355  000e 5f            	clrw	x
4356  000f 97            	ld	xl,a
4357  0010 1f03          	ldw	(OFST-1,sp),x
4358                     ; 1025   tmpccr3 |= (uint16_t)((uint16_t)tmpccr3h << 8);
...
4371                     ; 1027   return (uint16_t)tmpccr3;
4373  0021 1e03          	ldw	x,(OFST-1,sp)
4376  0023 5b04          	addw	sp,#4
4377  0025 81            	ret
4411                     ; 1035 uint16_t TIM2_GetCounter(void)
4411                     ; 1036 {
4412                     .text:	section	.text,new
4413  0000               _TIM2_GetCounter:
4415  0000 89            	pushw	x
4416       00000002      OFST:	set	2
4419                     ; 1037   uint16_t tmpcntr = 0;
4421                     ; 1039   tmpcntr =  ((uint16_t)TIM2->CNTRH << 8);
4423  0001 c6530a        	ld	a,21258
4424  0004 5f            	clrw	x
4425  0005 97            	ld	xl,a
4426  0006 4f            	clr	a
4427  0007 02            	rlwa	x,a
4428  0008 1f01          	ldw	(OFST-1,sp),x
4429                     ; 1041   return (uint16_t)( tmpcntr| (uint16_t)(TIM2->CNTRL));
4431  000a c6530b        	ld	a,21259
4432  000d 5f            	clrw	x
...
4442  0018 81            	ret
4466                     ; 1049 TIM2_Prescaler_TypeDef TIM2_GetPrescaler(void)
4466                     ; 1050 {
4467                     .text:	section	.text,new
4468  0000               _TIM2_GetPrescaler:
4472                     ; 1052   return (TIM2_Prescaler_TypeDef)(TIM2->PSCR);
4474  0000 c6530c        	ld	a,21260
4477  0003 81            	ret
4617                     ; 1068 FlagStatus TIM2_GetFlagStatus(TIM2_FLAG_TypeDef TIM2_FLAG)
4617                     ; 1069 {
...
4626                     ; 1070   FlagStatus bitstatus = RESET;
4628                     ; 1071   uint8_t tim2_flag_l = 0, tim2_flag_h = 0;
4632                     ; 1074   assert_param(IS_TIM2_GET_FLAG_OK(TIM2_FLAG));
...
4759  0024               L045:
4760                     ; 1109   TIM2->SR1 = (uint8_t)(~((uint8_t)(TIM2_FLAG)));
4762  0024 7b02          	ld	a,(OFST+2,sp)
4763  0026 43            	cpl	a
4764  0027 c75302        	ld	21250,a
4765                     ; 1110   TIM2->SR2 = (uint8_t)(~((uint8_t)((uint8_t)TIM2_FLAG >> 8)));
4767  002a 35ff5303      	mov	21251,#255
4768                     ; 1111 }
4771  002e 85            	popw	x
4772  002f 81            	ret
4837                     ; 1123 ITStatus TIM2_GetITStatus(TIM2_IT_TypeDef TIM2_IT)
4837                     ; 1124 {
...
4846                     ; 1125   ITStatus bitstatus = RESET;
4848                     ; 1126   uint8_t TIM2_itStatus = 0, TIM2_itEnable = 0;
4852                     ; 1129   assert_param(IS_TIM2_GET_IT_OK(TIM2_IT));
...
4971  001b               L655:
4972                     ; 1162   TIM2->SR1 = (uint8_t)(~TIM2_IT);
4974  001b 7b01          	ld	a,(OFST+1,sp)
4975  001d 43            	cpl	a
4976  001e c75302        	ld	21250,a
4977                     ; 1163 }
4980  0021 84            	pop	a
4981  0022 81            	ret
5033                     ; 1181 static void TI1_Config(uint8_t TIM2_ICPolarity,
5033                     ; 1182                        uint8_t TIM2_ICSelection,
5033                     ; 1183                        uint8_t TIM2_ICFilter)
5033                     ; 1184 {
...
5042                     ; 1186   TIM2->CCER1 &= (uint8_t)(~TIM2_CCER1_CC1E);
5044  0002 72115308      	bres	21256,#0
5045                     ; 1189   TIM2->CCMR1  = (uint8_t)((uint8_t)(TIM2->CCMR1 & (uint8_t)(~(uint8_t)( TIM2_CCMR_CCxS | TIM2_CCMR_ICxF )))
5045                     ; 1190                            | (uint8_t)(((TIM2_ICSelection)) | ((uint8_t)( TIM2_ICFilter << 4))));
...
5054  0011 c65305        	ld	a,21253
5055  0014 a40c          	and	a,#12
5056  0016 1a01          	or	a,(OFST+0,sp)
5057  0018 c75305        	ld	21253,a
5058                     ; 1193   if (TIM2_ICPolarity != TIM2_ICPOLARITY_RISING)
5060  001b 0d02          	tnz	(OFST+1,sp)
5061  001d 2706          	jreq	L3602
5062                     ; 1195     TIM2->CCER1 |= TIM2_CCER1_CC1P;
5064  001f 72125308      	bset	21256,#1
5066  0023 2004          	jra	L5602
5067  0025               L3602:
5068                     ; 1199     TIM2->CCER1 &= (uint8_t)(~TIM2_CCER1_CC1P);
5070  0025 72135308      	bres	21256,#1
5071  0029               L5602:
5072                     ; 1202   TIM2->CCER1 |= TIM2_CCER1_CC1E;
5074  0029 72105308      	bset	21256,#0
5075                     ; 1203 }
5078  002d 5b03          	addw	sp,#3
5079  002f 81            	ret
5131                     ; 1221 static void TI2_Config(uint8_t TIM2_ICPolarity,
5131                     ; 1222                        uint8_t TIM2_ICSelection,
5131                     ; 1223                        uint8_t TIM2_ICFilter)
5131                     ; 1224 {
...
5140                     ; 1226   TIM2->CCER1 &= (uint8_t)(~TIM2_CCER1_CC2E);
5142  0002 72195308      	bres	21256,#4
5143                     ; 1229   TIM2->CCMR2 = (uint8_t)((uint8_t)(TIM2->CCMR2 & (uint8_t)(~(uint8_t)( TIM2_CCMR_CCxS | TIM2_CCMR_ICxF ))) 
5143                     ; 1230                           | (uint8_t)(( (TIM2_ICSelection)) | ((uint8_t)( TIM2_ICFilter << 4))));
...
5152  0011 c65306        	ld	a,21254
5153  0014 a40c          	and	a,#12
5154  0016 1a01          	or	a,(OFST+0,sp)
5155  0018 c75306        	ld	21254,a
5156                     ; 1234   if (TIM2_ICPolarity != TIM2_ICPOLARITY_RISING)
5158  001b 0d02          	tnz	(OFST+1,sp)
5159  001d 2706          	jreq	L5112
5160                     ; 1236     TIM2->CCER1 |= TIM2_CCER1_CC2P;
5162  001f 721a5308      	bset	21256,#5
5164  0023 2004          	jra	L7112
5165  0025               L5112:
5166                     ; 1240     TIM2->CCER1 &= (uint8_t)(~TIM2_CCER1_CC2P);
5168  0025 721b5308      	bres	21256,#5
5169  0029               L7112:
5170                     ; 1244   TIM2->CCER1 |= TIM2_CCER1_CC2E;
5172  0029 72185308      	bset	21256,#4
5173                     ; 1245 }
5176  002d 5b03          	addw	sp,#3
5177  002f 81            	ret
5229                     ; 1261 static void TI3_Config(uint8_t TIM2_ICPolarity, uint8_t TIM2_ICSelection,
5229                     ; 1262                        uint8_t TIM2_ICFilter)
5229                     ; 1263 {
...
5238                     ; 1265   TIM2->CCER2 &=  (uint8_t)(~TIM2_CCER2_CC3E);
5240  0002 72115309      	bres	21257,#0
5241                     ; 1268   TIM2->CCMR3 = (uint8_t)((uint8_t)(TIM2->CCMR3 & (uint8_t)(~( TIM2_CCMR_CCxS | TIM2_CCMR_ICxF))) 
5241                     ; 1269                           | (uint8_t)(( (TIM2_ICSelection)) | ((uint8_t)( TIM2_ICFilter << 4))));
...
5250  0011 c65307        	ld	a,21255
5251  0014 a40c          	and	a,#12
5252  0016 1a01          	or	a,(OFST+0,sp)
5253  0018 c75307        	ld	21255,a
5254                     ; 1273   if (TIM2_ICPolarity != TIM2_ICPOLARITY_RISING)
5256  001b 0d02          	tnz	(OFST+1,sp)
5257  001d 2706          	jreq	L7412
5258                     ; 1275     TIM2->CCER2 |= TIM2_CCER2_CC3P;
5260  001f 72125309      	bset	21257,#1
5262  0023 2004          	jra	L1512
5263  0025               L7412:
5264                     ; 1279     TIM2->CCER2 &= (uint8_t)(~TIM2_CCER2_CC3P);
5266  0025 72135309      	bres	21257,#1
5267  0029               L1512:
5268                     ; 1282   TIM2->CCER2 |= TIM2_CCER2_CC3E;
5270  0029 72105309      	bset	21257,#0
5271                     ; 1283 }
...
5333  0000               L702:
5334  0000 73746d38735f  	dc.b	"stm8s_stdperiph_li"
5335  0012 625c6c696272  	dc.b	"b\libraries\stm8s_"
5336  0024 737464706572  	dc.b	"stdperiph_driver\s"
5337  0036 72635c73746d  	dc.b	"rc\stm8s_tim2.c",0
5357                     	end
