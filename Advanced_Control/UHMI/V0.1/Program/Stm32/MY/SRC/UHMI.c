...
void Display_Update(void)
{
	...
	UHMI_USART_Send_Char(number[Sys_Status.AlcoholPer / 100]);
	UHMI_USART_Send_Char(number[Sys_Status.AlcoholPer  % 100 / 10]);
	UHMI_USART_Send_Char(number[Sys_Status.AlcoholPer  % 10]);
	UHMI_USART_Send_Char('\"');
	UHMI_USART_Send_Char(0xff);
	UHMI_USART_Send_Char(0xff);
	UHMI_USART_Send_Char(0xff);
