...
void Display_Update(void)
{
	...
	/* Time */
	UHMI_USART_Send_Str("t0.txt=\"");
	UHMI_USART_Send_Char(number[Sys_Status.Runing_Time_s / 60 / 60 % 1000 / 100]);
	UHMI_USART_Send_Char(number[Sys_Status.Runing_Time_s / 60 / 60 % 100 / 10]);
	UHMI_USART_Send_Char(number[Sys_Status.Runing_Time_s / 60 / 60 % 10]);
	UHMI_USART_Send_Char('\"');
	UHMI_USART_Send_Char(0xff);
	UHMI_USART_Send_Char(0xff);
	UHMI_USART_Send_Char(0xff);
	UHMI_USART_Send_Str("t2.txt=\"");
	UHMI_USART_Send_Char(number[Sys_Status.Runing_Time_s / 60 % 100 / 10]);
	UHMI_USART_Send_Char(number[Sys_Status.Runing_Time_s / 60 % 10]);
	UHMI_USART_Send_Char('\"');
	UHMI_USART_Send_Char(0xff);
	UHMI_USART_Send_Char(0xff);
	UHMI_USART_Send_Char(0xff);
